...
var _i18n = {
  es: {
    ...
    "inst.badge": "Corporativo a Medida",
    "inst.num":   "Módulo 03",
    "inst.title": "Infraestructura Privada",
    "inst.sub1":  "Trato privado · Contrato firmado",
    "inst.sub2":  "Facturación formal SWIFT",
    "inst.li1":   "White-label completo bajo dominio corporativo propio",
    "inst.li2":   "Infraestructura dedicada — On-Premise / Nube Privada",
    "inst.li3":   "Créditos ilimitados · volumen corporativo sin restricción",
    "inst.li4":   "Monitor de auditoría global multi-analista en tiempo real",
    "inst.li5":   "Soporte técnico 24/7 con SLA garantizado + NDA firmado",
    "inst.btn":   "Contactar Oficial de Cuentas",
    "inst.note":  "Reunión técnica + borrador de NDA en menos de 2 h",
  },
  en: {
    ...
    "inst.badge": "Institutional Custom",
    "inst.num":   "Module 03",
    "inst.title": "Private Infrastructure",
    "inst.sub1":  "Private agreement · Signed contract",
    "inst.sub2":  "Formal SWIFT invoicing",
    "inst.li1":   "Full white-label under your own corporate domain",
    "inst.li2":   "Dedicated infrastructure — On-Premise / Private Cloud",
    "inst.li3":   "Unlimited credits · unrestricted corporate volume",
    "inst.li4":   "Global multi-analyst audit monitor in real time",
    "inst.li5":   "24/7 technical support with guaranteed SLA + signed NDA",
    "inst.btn":   "Contact Account Manager",
    "inst.note":  "Technical meeting + NDA draft in under 2 h",
  }
};
...
function mostrarTerminos(user) {
  ...
  overlay.innerHTML =
    ...
    + '<div class="tc-subtitulo">Por favor, leé y aceptá los términos antes de continuar. Última actualización: junio 2026. <a href="terminos.html" target="_blank" style="color:#1a56a0">Ver versión completa</a></div>'
    + '</div>'
    + '<div class="tc-body">'

    + '<div class="tc-section"><h3>1. Naturaleza del Servicio</h3><p>AHC Intelligence es una plataforma de inteligencia financiera y compliance que provee análisis de referencia basados en inteligencia artificial. Los reportes, análisis y resultados generados <strong>no constituyen asesoramiento legal, financiero, regulatorio ni inversión formal</strong>. Son herramientas de apoyo para profesionales calificados que actúan bajo su propia responsabilidad profesional y regulatoria.</p></div>'

    + '<div class="tc-section"><h3>2. Metodología y Alcance del Análisis</h3><p>Los análisis de due diligence y screening de compliance emplean <strong>búsqueda de medios adversos e inteligencia de fuentes abiertas (OSINT) mediante IA</strong>. Este sistema realiza búsquedas en fuentes públicas y medios disponibles en internet, pero <strong>no accede directamente</strong> a bases de datos oficiales de sanciones (OFAC SDN, sistema de sanciones ONU) ni a bases PEP verificadas de reguladores. Los resultados reflejan menciones encontradas en fuentes abiertas al momento del análisis. El usuario es responsable de complementar estos resultados con la consulta directa a bases oficiales cuando el perfil de riesgo lo requiera.</p></div>'

    + '<div class="tc-section"><h3>3. Uso Autorizado</h3><p>El acceso está reservado para profesionales del sector financiero, legal y compliance, asesores de inversión, estudios jurídicos e instituciones financieras. El usuario declara ser un profesional calificado con capacidad para interpretar los análisis en su contexto regulatorio. Queda expresamente <strong>prohibido</strong> el uso de la plataforma para actividades ilícitas, evasión fiscal, lavado de activos, o para afirmar ante terceros que los resultados constituyen una verificación oficial de sanciones o bases PEP.</p></div>'

    + '<div class="tc-section"><h3>4. Confidencialidad de Datos</h3><p>AHC Intelligence no comparte los datos ingresados con terceros no autorizados. La información procesada se utiliza exclusivamente para generar los análisis solicitados, de conformidad con la legislación uruguaya de protección de datos personales. El usuario declara contar con la debida autorización para ingresar datos de terceros analizados, bajo su exclusiva responsabilidad legal.</p></div>'

    + '<div class="tc-section"><h3>5. Limitación de Responsabilidad</h3><p>En la máxima medida permitida por la ley: (a) AHC Intelligence no garantiza la exactitud, completitud ni actualidad de los resultados generados; (b) no será responsable por decisiones comerciales, regulatorias, legales o de inversión adoptadas en base a los análisis; (c) la responsabilidad total de AHC Intelligence no podrá exceder el monto efectivamente pagado por el usuario en los 12 meses anteriores al evento; (d) AHC Intelligence no será responsable por daños indirectos, consecuentes, especiales o punitivos.</p></div>'

    + '<div class="tc-section"><h3>6. Indemnización</h3><p>El usuario se compromete a defender, indemnizar y mantener indemne a AHC Intelligence, sus directivos y colaboradores frente a cualquier reclamo, daño, costo o gasto (incluidos honorarios legales) que surja de: (a) el uso de la plataforma en violación de estos términos; (b) las decisiones adoptadas en base a los análisis generados; (c) el ingreso de datos de terceros sin la debida autorización; (d) cualquier afirmación a terceros de que los resultados constituyen una verificación oficial de sanciones o bases PEP.</p></div>'

    + '<div class="tc-section"><h3>7. Sistema de Créditos y Suscripciones</h3><p>El plan Trial otorga 150 créditos con validez de 7 días. Los planes pagos se renuevan automáticamente según el ciclo seleccionado. Los créditos no utilizados no son acumulables entre ciclos. El reembolso está sujeto a las políticas vigentes al momento de la contratación.</p></div>'

    + '<div class="tc-section"><h3>8. Propiedad Intelectual</h3><p>Todo el contenido, metodología y tecnología de la plataforma es propiedad exclusiva de AHC Intelligence. Los reportes generados son para uso interno del cliente suscriptor. Queda prohibida su redistribución comercial sin autorización escrita.</p></div>'

    + '<div class="tc-section"><h3>9. Jurisdicción y Ley Aplicable</h3><p>Estos términos se rigen por la legislación de la <strong>República Oriental del Uruguay</strong>. Para cualquier controversia, las partes se someten a la jurisdicción exclusiva de los tribunales de la ciudad de <strong>Montevideo</strong>, renunciando expresamente a cualquier otro fuero que pudiera corresponder.</p></div>'

    + '<div class="tc-section"><h3>10. Modificaciones</h3><p>AHC Intelligence se reserva el derecho de modificar estos términos con un preaviso de 15 días notificado por email o en la plataforma. El uso continuado implica la aceptación de las condiciones actualizadas.</p></div>'
    ...
    + '<span>He leído y acepto los <strong>Términos y Condiciones de Uso</strong> de AHC Intelligence. Entiendo que los análisis son de referencia, no constituyen asesoramiento profesional formal, y que el sistema realiza búsqueda en fuentes abiertas sin acceso directo a bases oficiales de sanciones.</span>'
    + '</label>'
    + '<div class="tc-btns">'
